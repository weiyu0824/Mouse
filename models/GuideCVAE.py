...
class GuideCVAE(nn.Module):
    ...
    def forward(self, x, label1, label2, guide):
        ...
        recon_x = self.decode(embeddding, label1, label2, guide)



        return recon_x, mean, logvar
    
    def sample(self, label1, label2, guide):
        ...
        return self.decode(embeddding, label1, label2, guide)
